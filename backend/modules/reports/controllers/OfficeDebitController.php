...
use backend\models\OfficeDebitSearch;
...
/**
 * OfficeDebitController implements the CRUD actions for OfficeDebit model.
 */
class OfficeDebitController extends Controller
{
    ...
    /**
     * Lists all OfficeDebit models.
     *
     * @return string
     */
    public function actionIndex()
    {
        $searchModel = new OfficeDebitSearch();
    ...
    /**
     * Displays a single OfficeDebit model.
     * @param int $id ID
     * @return string
    ...
    /**
     * Creates a new OfficeDebit model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return string|\yii\web\Response
     */
    public function actionCreate()
    {
        $model = new OfficeDebit();
    ...
    /**
     * Updates an existing OfficeDebit model.
    ...
    /**
     * Deletes an existing OfficeDebit model.
    ...
    /**
     * Finds the OfficeDebit model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param int $id ID
     * @return OfficeDebit the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = OfficeDebit::findOne(['id' => $id])) !== null) {
            return $model;
        }
