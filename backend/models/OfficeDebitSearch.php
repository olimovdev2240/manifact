...
/**
 * OfficeDebitSearch represents the model behind the search form of `backend\models\OfficeDebit`.
 */
class OfficeDebitSearch extends OfficeDebit
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $query = OfficeDebit::find()->orderBy(['id'=>SORT_DESC]);
