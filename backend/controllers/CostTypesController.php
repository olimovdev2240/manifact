...
use backend\models\CostTypesSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * CostTypesController implements the CRUD actions for CostTypes model.
 */
class CostTypesController extends Controller
{
    ...
    /**
     * Displays a single CostTypes model.
     * @param int $id ID
     * @return string
    ...
    {
        if (($model = CostTypes::findOne(['id' => $id])) !== null) {
            return $model;
        }
